...
function updataBoardView() {
    ...
    for (var i = 0; i < 4; i++)
        for (var j = 0; j < 4; j++) {
            if (board[i][j] == 1024 || board[i][j] == 2048 || board[i][j] == 4096) {
                $('#number-cell-' + i + '-' + j).css('font-size', 0.4 * cellSideLength + 'px');
                //$('#number-cell-' + i + '-' + j).text('048');
            }
        ...
        for (var j = 1; j < 4; j++) {
            if (board[i][j] != 0) {
                for (var k = 0; k < j; k++) {
                    ...
                    else if (board[i][k] == board[i][j] && noBlockHorizontalCol(i, k, j, board) && !hasConflicted[i][j]) {
                        //move
                        showMoveAnimation(i, j, i, k);
                        //add
                        board[i][k] += board[i][j];
        ...
        for (var j = 2; j >= 0; j--) {
            if (board[i][j] != 0) {
                for (var k = 3; k > j; k--) {
                    ...
                    else if (board[i][k] == board[i][j] && noBlockHorizontalCol(i, j, k, board) && !hasConflicted[i][j]) {
                        //move
                        showMoveAnimation(i, j, i, k);
                        //add
                        board[i][k] += board[i][j];
        ...
        for (var i = 1; i < 4; i++) {
            if (board[i][j] != 0) {
                for (var k = 0; k < i; k++) {
                    ...
                    else if (board[k][j] == board[i][j] && noBlockHorizontalRow(j, k, i, board) && !hasConflicted[i][j]) {
                        //move
                        showMoveAnimation(i, j, i, k);
                        //add
                        board[k][j] += board[i][j];
        ...
        for (var i = 2; i >= 0; i--) {
            if (board[i][j] != 0) {
                for (var k = 3; k > i; k--) {
                    ...
                    else if (board[k][j] == board[i][j] && noBlockHorizontalRow(j, i, k, board) && !hasConflicted[i][j]) {
                        //move
                        showMoveAnimation(i, j, i, k);
                        //add
                        board[k][j] += board[i][j];
